...
// --- REMOVED: Escrow.com API Configuration ---
// Escrow integration has been replaced with direct bank transfer system
...
exports.searchScryDex = functions.https.onCall(async (data, context ) => {
    ...
    try {
        ...
        return { success: false, error: 'Server configuration error: could not access API credentials.' };
    }
...
// =================================================================================================
// REMOVED: ESCROW TRADING SYSTEM - Replaced with Direct Bank Transfer
// =================================================================================================
