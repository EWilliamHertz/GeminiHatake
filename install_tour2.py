...
# More robust selectors to find the correct elements
IDS_TO_ADD = {
    'app.html': [('div#feed-content-container', 'feed-container')],
    'articles.html': [('div#articles-grid', 'articles-grid')],
    ...
    'settings.html': [('nav[aria-label="Sidebar"]', 'settings-nav')]
}
