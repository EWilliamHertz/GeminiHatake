...
class EnhancedMarketplace {
    ...
    async loadMarketplaceData() {
        ...
        try {
            ...
            this.showToast('Failed to load marketplace listings', 'error');
        } finally {
            if (loadingIndicator) {
    ...
    applyFilters() {
        ...
        this.applyGameSpecificFilters(filtered);
    ...
    clearFilters() {
        ...
        document.getElementById('mtg-type-filter').value = '';
        document.getElementById('pokemon-type-filter').value = '';
        document.getElementById('pokemon-graded-filter').checked = false;
        document.getElementById('lorcana-graded-filter').checked = false;
        document.getElementById('gundam-series-filter').value = '';
